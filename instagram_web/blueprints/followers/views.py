...
def index(acc_id):
    ...
    return render_template('followers/review_requests.html',followers=followers,S3_LOCATION=S3_LOCATION)

# Process follow requests
@followers_blueprint.route("/update_requests/<int:acc_id>/<int:follower_id>/status=<int:accept>")
@login_required
